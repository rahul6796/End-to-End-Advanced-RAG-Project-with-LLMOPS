...
def stub_model_loader(monkeypatch):
    ...
    import multi_docs_chat.utils.model_loader as ml_mod
    from multi_docs_chat.utils import model_loader as ml_mod2
    ...
    import multi_docs_chat.src.document_ingestion.data_ingestion as di
    import multi_docs_chat.src.document_chat.retrieval as r
